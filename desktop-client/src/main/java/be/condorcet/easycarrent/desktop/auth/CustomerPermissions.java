...
/**
 * Client-side view of the backend's customer authorization rules.
 *
 * <p>Reflects the backend security configuration exactly: reading customers is
 * allowed for USER and ADMIN, while creating, updating, and deleting a customer
