...
/**
 * Client-side view of the backend's vehicle authorization rules.
 *
 * <p>Reflects the backend security configuration exactly: reading vehicles is
 * allowed for USER and ADMIN, while creating, updating, and deleting a vehicle
 ...
 */
public final class VehiclePermissions {

	private VehiclePermissions() {
	}
