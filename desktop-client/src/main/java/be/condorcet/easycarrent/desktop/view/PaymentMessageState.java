...
/**
 * JavaFX-free placement model for the two Payment message areas.
 *
 ...
 * without the graphical toolkit. It reuses the lesson from the Customers and
 * Rentals screens so a stale form error can never linger above the table.</p>
 */
public final class PaymentMessageState {
