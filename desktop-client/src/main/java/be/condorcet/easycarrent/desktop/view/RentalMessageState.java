...
/**
 * JavaFX-free placement model for the two Rental message areas.
 *
 ...
 * without the graphical toolkit. It reuses the lesson from the Customers screen so
 * a stale form error can never linger above the table.</p>
 */
public final class RentalMessageState {
	...
	/**
	 * Shows a general error/operation message above the table (for list, refresh,
	 * delete, and transition feedback) and clears any form errors.
	 */
